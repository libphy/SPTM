...
ACTION_EXPERIMENT_ID = get_from_env('ACTION_EXPERIMENT_ID', str, 'demo_L') # '0102_L'
EDGE_EXPERIMENT_ID = get_from_env('EDGE_EXPERIMENT_ID', str, 'demo_R') # '0103_R'
...
ACTION_MODEL_WEIGHTS_PATH = ACTION_MODEL_PATH  #os.path.join((MODELS_PATH_TEMPLATE % ACTION_EXPERIMENT_ID), 'model_weights.h5') 
EDGE_MODEL_PATH = os.path.join((MODELS_PATH_TEMPLATE % EDGE_EXPERIMENT_ID), 'model.%.6d.h5' % EDGE_MODEL_ITERATION)
EDGE_MODEL_WEIGHTS_PATH = EDGE_MODEL_PATH #os.path.join((MODELS_PATH_TEMPLATE % EDGE_EXPERIMENT_ID), 'model_weights.h5')
